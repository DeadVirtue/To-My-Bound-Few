...
Logic:1. Select all .friend-section2. Hide all3. Show matching id `${name}`4. Save name in localStorage
...
If buttons work but nothing shows:- ID naming mismatch- Missing '' suffix
