...
<section class="friend-section" id="nomore">

JS relies on this naming pattern:data-friend="name"id="name"
...
Each friend card contains:- .friend- .card-content (flex container)- .card-info (description)- .friend-gallery (grid layout)
...
If images don’t load:- Check for missing ../- Check folder spelling- Check case sensitivity
...
\- target="\_blank" opens new tab- title gives tooltip- alt is NOT valid for <a>, only for <img>
